...
### 3.10 The ownership model — the six rulings in one place

Six ownership rulings landed across Phases 3, 4, and 6. Each was made deliberately, with its reasoning recorded where it landed; this section exists so the MODEL is legible in one place instead of six. The rulings are coherent because they all answer the same question — *whose record is this?* — and the answer differs by what kind of thing the value is, not by which side touched it last.
