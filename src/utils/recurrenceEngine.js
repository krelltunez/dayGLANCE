...
export const getRecurrencePresets = (dateStr, t, language = 'en') => {
  ...
  return [
    ...
    { label: translate('recurrence.monthlyOnDate', { day: monthDay, suffix }, `Monthly on the ${monthDay}${suffix}`), value: { type: 'monthly', monthDay: monthDay, monthWeekday: null } },
    { label: translate('recurrence.monthlyOnOrdinalWeekday', { week: weekOfMonth, ordinal: ordinals[weekOfMonth], day: localizedDay }, `Monthly on the ${ordinals[weekOfMonth]} ${dayName}`), value: { type: 'monthly', monthDay: null, monthWeekday: { week: weekOfMonth, day: taskDate.getDay() } } },
